...
class EmailConfig {
	...
	public $reminder_auth = array(
		...
		'emailFormat' =>	'text',
		'subject' =>		'IISサイトのパスワード再発行完了メールです',
		'from' =>			array('info@kric.co.jp' => 'KRIC'),
		'charset' =>		'jis',
		'headerCharset' =>	'jis',
        'host' => 			'kric.sakura.ne.jp',
	...
	public $bd_send = array(
		...
		'template' =>		'bd_send',
		'emailFormat' =>	'text',
		'subject' =>		'IISサイトビジネスダイレクトからのお知らせ',
		'from' =>			array('info@kric.co.jp' => 'KRIC'),
		'charset' =>		'jis',
		'headerCharset' =>	'jis',
        'host' => 			'kric.sakura.ne.jp',
