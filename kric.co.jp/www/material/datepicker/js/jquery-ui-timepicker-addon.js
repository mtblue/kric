		...
		_injectTimePicker: function() {
			...
			if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
				...
				for(i=0,l=this.units.length; i<l; i++){
					...
					html += '<div class="ui_tpicker_'+ litem +'_label"' + (show ? '' : noDisplay) + ' style="float:left;">' + o[litem +'Text'] + '<div class="ui_tpicker_'+ litem +'_slider"' + (show ? '' : noDisplay) + ' style="float:left;"></div></div>' + 
